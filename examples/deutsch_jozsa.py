...
if __name__ == "__main__":
    ...
    print(f"Function is balanced with {sum([r[0] for r in results])}% probability measured")
    ...
    print(f"Function is constant with {100 - sum([r[0] for r in results])}% probability measured")
